			...
			<div class="col-sm-6 post-item">
				<article id="post-27" class="post-27 post type-post status-publish format-standard has-post-thumbnail hentry category-branding category-design category-printing tag-business tag-lifestyle tag-music tag-news tag-travel">
					<div class="post-preview">
						<a href="../mini-california-sushi-cones/index.html"><img width="1024" height="576" src="<?php echo $postImg; ?>" class="attachment-large size-large wp-post-image" alt="" /></a>
					</div>
					<div class="post-header">
						<h2 class="post-title font-alt"><a href="../mini-california-sushi-cones/index.html"><?php the_title(); ?></a></h2>
					...
					<div class="post-more">
						<a class="font-alt" href="../mini-california-sushi-cones/index.html">Leer más &rarr;</a>
					</div>
				</article>
			</div>
<?php
